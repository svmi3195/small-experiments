...
document.addEventListener("DOMContentLoaded", function(event) {
  num = getNumber();
  sonnet = getSonnet(num).lines;
  encrypted = encrypt(sonnet);
  document.getElementById("sonnet").innerHTML = encrypted;
  visualize();
});
  
  document.getElementById("random").addEventListener("click", function(e){
    num = Math.floor(Math.random() * (155 - 1)) + 1;    
    var numStr = num.toString();
    while(numStr.length < 3){
      numStr = '0' + numStr;
    }
    document.getElementById("1").innerHTML = numStr[0];
    document.getElementById("2").innerHTML = numStr[1];
    document.getElementById("3").innerHTML = numStr[2];
  ...
  document.getElementById("1").addEventListener("click", function(e){
    ...
    }else if (e.target.innerHTML == 0 && Number.parseInt(document.getElementById("2").innerHTML + document.getElementById("3").innerHTML) <= 54){
  ...
  document.getElementById("2").addEventListener("click", function(e){
    if(document.getElementById("1").innerHTML == 1 && e.target.innerHTML == 5){
      e.target.innerHTML = 0;
    }else if (document.getElementById("1").innerHTML == 1 && e.target.innerHTML == 4 && document.getElementById("3").innerHTML == 1){
      e.target.innerHTML = 0;
    }else if (e.target.innerHTML == 9){
      e.target.innerHTML = 0;
    }else{
      e.target.innerHTML = Number.parseInt(e.target.innerHTML) + 1;
    }
    update();
    visualize();
  });
  ...
  document.getElementById("3").addEventListener("click", function(e){
    if(document.getElementById("1").innerHTML == 1 && document.getElementById("2").innerHTML == 5 && e.target.innerHTML == 4){
      e.target.innerHTML = 0;
    }else if (e.target.innerHTML == 9){
      e.target.innerHTML = 0;
    }else{
...
function getNumber(){
  return Number.parseInt(document.getElementById("1").innerHTML + document.getElementById("2").innerHTML + document.getElementById("3").innerHTML);
};

function getSonnet(num){  
  for(var i = 0; i < sonnets.length; i++){
    if(sonnets[i].title.includes('Sonnet '+num+':')){
      //console.log(sonnets[i].title)
      return sonnets[i];
    }
  }  
};
...
function visualize(){
  var timer = setInterval(
    function(){ 
      encrypted = decrypt(sonnet, encrypted);
      document.getElementById("sonnet").innerHTML = encrypted;
      
      if(encrypted == sonnet.join('<br>')){
        clearInterval(timer);
